...
#SBATCH --mem=20GB
#SBATCH -J MOT_data
#SBATCH -o /users/aarjun1/data/aarjun1/pathtracker/mot/pathtracker-data-main/logs/MI_%A_%a_%J.out
#SBATCH -e /users/aarjun1/data/aarjun1/pathtracker/mot/pathtracker-data-main/logs/MI_%A_%a_%J.err
#SBATCH --account=carney-tserre-condo
##SBATCH --array=0-1

cd ~/data/aarjun1/pathtracker/mot/pathtracker-data-main/
